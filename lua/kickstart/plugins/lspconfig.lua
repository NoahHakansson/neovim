    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>lr', vim.lsp.buf.rename, 'Re[n]ame')
          ...
          map('<leader>lS', require('telescope.builtin').lsp_dynamic_workspace_symbols, 'Open Workspace [S]ymbols')
      ...
      local servers = {
        ...
        -- disabled HTMX for now as it doesn't seem to be respecting filetypes and destroys hover capabilities in ts/js files.
